...
class Driver(Person):
    ...
    def display_info(self):
        ...
        print("Name :",self.name)
        print("Age :",self.age)
        print("Driver_id:",self.__driver_id)
        print("Gender :",self.Gender)
        print("Department:",self.Department)
    @staticmethod
    def Bus_policy():
        print("\nBus policy:")
        print("Bus Location Gajuwaka.")
    @classmethod
    def total_driver(cls):
            print("Total Driver Members:",cls.driver_count)
...
driver1 = Driver("sankar",20,"123","Male","Transport")
